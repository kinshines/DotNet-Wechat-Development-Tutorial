...
namespace WebApplicationPayonlineDemo.Controllers
{
    public class aliPayController : Controller
    {
        ...
        public ActionResult Index(string productCode, string productName, string productDesc, string orderno, int total_fee)
        {
            ...
            string fee = (total_fee*1.0F/100.0).ToString(); //商品价格，也可称为订单的总金额 
            //服务器通知url（Alipay_Notify.aspx文件所在路经），必须是完整的路径地址 
            string notify_url = "http://www.youxuewang.com.cn/onlinePay/alipay/Notify";
            //服务器返回url（Alipay_Return.aspx文件所在路经），必须是完整的路径地址 
            string return_url = "http://www.youxuewang.com.cn/onlinePay/Home/Orderlist";
...
"_input_charset="+_input_charset
            ...
            Response.Write("<input type='text' name='service' value=" + service + ">");
            Response.Write("<input type='text' name='partner' value=" + partner + ">");
            Response.Write("<input type='text' name='seller_email' value=" + seller_email + ">");
            Response.Write("<input type='text' name='out_trade_no' value=" + out_trade_no + ">");
            Response.Write("<input type='text' name='subject' value=" + subject + ">");
            Response.Write("<input type='text' name='body' value=" + body + ">");
            Response.Write("<input type='text' name='total_fee' value=" + fee + ">");
            Response.Write("<input type='text' name='show_url' value=" + show_url + ">");
            Response.Write("<input type='text' name='return_url' value=" + return_url + ">");
            Response.Write("<input type='text' name='notify_url' value=" + notify_url + ">");
            Response.Write("<input type='text' name='payment_type' value=1>");
            Response.Write("<input type='text' name='sign' value=" + aliay_url + ">");
            Response.Write("<input type='text' name='sign_type' value=" + sign_type + ">");
            Response.Write("</form>");
