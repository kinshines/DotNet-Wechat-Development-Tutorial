...
namespace wxBase.MessageEncryption
{
    public class WXBizMsgCrypt
    {
        ...
        {
            WXBizMsgCrypt_OK = 0,
            WXBizMsgCrypt_ValidateSignature_Error = -40001,  // 签名验证错误
            WXBizMsgCrypt_ParseXml_Error = -40002,  // xml解析失败
            WXBizMsgCrypt_ComputeSignature_Error = -40003,  // sha加密生成签名失败
            WXBizMsgCrypt_IllegalAesKey = -40004,  // AESKey 非法
            WXBizMsgCrypt_ValidateAppid_Error = -40005, // appid 校验错误
            WXBizMsgCrypt_EncryptAES_Error = -40006, // AES 加密失败
            WXBizMsgCrypt_DecryptAES_Error = -40007, // AES 解密失败
            WXBizMsgCrypt_IllegalBuffer = -40008,  // 解密后得到的buffer非法
            WXBizMsgCrypt_EncodeBase64_Error = -40009, // base64加密异常
            WXBizMsgCrypt_DecodeBase64_Error = -40010  // base64解密异常
        };
