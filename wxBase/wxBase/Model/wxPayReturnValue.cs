...
namespace wxBase.Model
{
    ...
    public class wxPayReturnValue
    {
        ...
        #region wxPayReturnValue
        public wxPayReturnValue()
        {
            hasError = false;
            errorCode = "";
            message = "";
        ...
        public wxPayReturnValue(bool hasError, string errCode, string message, object retObj)
        {
        ...
        public wxPayReturnValue(bool hasError, string errCode, string message)
        {
            this.hasError = hasError;
            this.errorCode = errCode;
            this.message = message;
        ...
        public wxPayReturnValue(bool hasError, string message)
        {
            this.hasError = hasError;
            this.errorCode = null;
            this.message = message;
        ...
        public wxPayReturnValue(string errCode, string errMessage)
        {
            this.hasError = true;
            this.errorCode = errCode;
        ...
        public wxPayReturnValue(string errMessage)
        {
            this.hasError = false;
            this.errorCode = null;
            this.message = errMessage;
        ...
        public void PutValue(wxPayReturnValue retValue)
        {
            if (mapData == null)
            {
                mapData = new Hashtable(5);
