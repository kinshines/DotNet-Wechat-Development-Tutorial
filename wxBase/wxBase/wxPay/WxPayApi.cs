    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            LogService.Write("PayApi- MicroPay request : " + xml);
            string response = HttpService.Post(url, xml);//调用HTTP通信接口以提交数据到API
            LogService.Write("WxPayApi - MicroPay response : " + response);
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Write("WxPayApi - OrderQuery request : " + xml);
            string response = HttpService.Post(url, xml);//调用HTTP通信接口提交数据
            LogService.Write("WxPayApi - OrderQuery response : " + response);
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Write("WxPayApi - Reverse request : " + xml);

            string response = HttpService.Post( url, xml);

            LogService.Write("WxPayApi - Reverse response : " + response);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Write("WxPayApi - Refund request : " + xml);
            string response = HttpService.Post( url, xml);//调用HTTP通信接口提交数据到API
            LogService.Write("WxPayApi - Refund response : " + response);
	    ...
	    */
        public static WxPayData RefundQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Write("WxPayApi - RefundQuery request : " + xml);
            string response = HttpService.Post(url,xml );//调用HTTP通信接口以提交数据到API
            LogService.Write("WxPayApi- RefundQuery response : " + response);
        ...
        */
        public static WxPayData DownloadBill(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Write("WxPayApi - DownloadBill request : " + xml);
            string response = HttpService.Post(url, xml);//调用HTTP通信接口以提交数据到API
            LogService.Write("WxPayApi - DownloadBill result : " + response);
	    ...
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Write("WxPayApi - ShortUrl request : " + xml);
            string response = HttpService.Post(url, xml);
            LogService.Write("WxPayApi - ShortUrl response : " + response);
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Write("WxPayAp - UnfiedOrder request : " + xml);
            string response = HttpService.Post(url, xml);
            LogService.Write("WxPayApi - UnfiedOrder response : " + response);
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj, int timeOut = 1)
        {
            ...
            LogService.Write("WxPayApi - Report request : " + xml);

            string response = HttpService.Post(url, xml);

            LogService.Write("WxPayApi - Report response : " + response);
