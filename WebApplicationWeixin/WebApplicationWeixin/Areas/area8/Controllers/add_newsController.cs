...
{
    public class add_newsController : Controller
    {
        // GET: area8/add_news
      ...
      "\"thumb_media_id\":\"kUG69QGD3DAgXqRYknfg2YfLOaXLGFDJHyNnowkVxkMIdCof8pLJJKR7RXLJfZOC\"," +
      "\"author\": \"亿欧\"," +
      ...
      + "\"content_source_url\":\"http://iyiou.baijia.baidu.com/article/600491\" }" + "] }";
            string json = wxMediaService.add_news(content);
            UploadMediaResult result = JSONHelper.JSONToObject<UploadMediaResult>(json);
