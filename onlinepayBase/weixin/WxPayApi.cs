...
namespace onlinepayBase.weixin
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut = 10)
        {
            ...
            LogService.Debug("WxPayApi", "MicroPay request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            LogService.Debug("WxPayApi", "MicroPay response : " + response);
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Debug("WxPayApi", "OrderQuery request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口提交数据
            LogService.Debug("WxPayApi", "OrderQuery response : " + response);
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Debug("WxPayApi", "Reverse request : " + xml);

            string response = HttpService.Post(xml, url, true, timeOut);

            LogService.Debug("WxPayApi", "Reverse response : " + response);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Debug("WxPayApi", "Refund request : " + xml);
            string response = HttpService.Post(xml, url, true, timeOut);//调用HTTP通信接口提交数据到API
            LogService.Debug("WxPayApi", "Refund response : " + response);
	    ...
	    */
        public static WxPayData RefundQuery(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Debug("WxPayApi", "RefundQuery request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            LogService.Debug("WxPayApi", "RefundQuery response : " + response);
        ...
        */
        public static WxPayData DownloadBill(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Debug("WxPayApi", "DownloadBill request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
            LogService.Debug("WxPayApi", "DownloadBill result : " + response);
	    ...
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Debug("WxPayApi", "ShortUrl request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            LogService.Debug("WxPayApi", "ShortUrl response : " + response);
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            LogService.Debug("WxPayApi", "UnfiedOrder request : " + xml);
            string response = HttpService.Post(xml, url, false, timeOut);
            LogService.Debug("WxPayApi", "UnfiedOrder response : " + response);
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj, int timeOut = 1)
        {
            ...
            LogService.Info("WxPayApi", "Report request : " + xml);

            string response = HttpService.Post(xml, url, false, timeOut);

            LogService.Info("WxPayApi", "Report response : " + response);
