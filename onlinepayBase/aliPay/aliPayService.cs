...
namespace onlinepayBase.aliPay
{
    public static  class aliPayService
    {
        // 游学网支付宝收款账号 
        public static string Alipay_seller_email = "dachao@dachao.com.cn";
        // 游学网支付宝合作者身份(PID)
        public static string Alipay_pid = "2088121855963523";
        // 游学网支付宝安全校验码(Key)默认加密： 
        public static string Alipay_key = "e61sj215ehgvj7c9bzfifgfumdaokkzv";
